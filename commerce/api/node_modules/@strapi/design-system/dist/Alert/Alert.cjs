"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const t=require("react/jsx-runtime"),h=require("styled-components"),a=require("@strapi/icons"),o=require("../Box/Box.cjs"),i=require("../Typography/Typography.cjs"),g=require("../Flex/Flex.cjs"),f=require("../themes/utils.cjs"),s=require("./utils.cjs"),j=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},l=j(h),y=l.default(o.Box)`
  flex: 1;
  flex-wrap: wrap;
  display: flex;
  flex-direction: row;
