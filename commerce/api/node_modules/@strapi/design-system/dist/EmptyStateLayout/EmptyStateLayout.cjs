"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const p=require("react"),c=require("prop-types"),y=require("styled-components"),f=require("../Typography/Typography.cjs"),o=require("../Box/Box.cjs"),r=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},a=r(p),t=r(c),d=r(y),g=d.default(o.Box)`
  display: flex;
